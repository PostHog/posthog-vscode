...
- [ ] **CLEAN-02**: Remove HogQL editor (HogQLEditorProvider, .hogql language registration, commands)
...
- [ ] **CLEAN-05**: Remove all package.json contributions for dropped features (commands, menus, languages)
